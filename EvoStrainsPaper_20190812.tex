...
%\subtitle{Countably Many Strains in Compartmental Epidemic Models}

\titlerunning{Endemic evolving pathogens with strain dependant immunity}        % if too long for running head

\author{Adam Griffin         \and
        Gareth O. Roberts 			\and
        Simon E.F. Spencer%etc.
}

\authorrunning{A.Griffin, G.O.Roberts, S.E.F.Spencer} % if too long for running head

\institute{Statistics Department \at
              University of Warwick, Gibbet Hill Road, Coventry, CV4 7AL, UK.               
              \email{adam.griffin@warwick.ac.uk, s.e.f.spencer@warwick.ac.uk, g.o.roberts@warwick.ac.uk}           %  \\
...
\keywords{Epidemiology \and Probabilistic models \and Quasistationary distributions}
%\PACS{02.50.Ey}
\subclass{92D30 \and 97M60 \and 60J28}
\end{abstract}
...
% 	which equals the unique LCD of the process, 
...
\begin{figure}[h!]
	\centering
 		\includegraphics{./Figures/bbtree.pdf}
 		\includegraphics{./Figures/ddtree.pdf}
...
\end{itemize}
We will focus on the E-SIS model, but also discuss for each statistic how the addition of an immune period, as in the E-SIRS models, changes the number of infectives and strain diversity.
...
\begin{figure}
	\centering
	\includegraphics{./Figures/betaThetaVaryInfectivesHeatmapA.pdf}
...
\begin{figure}
	\centering
 		\includegraphics{./Figures/betaVaryInfectivesA.pdf}
 		\includegraphics{./Figures/nVaryInfectivesA.pdf}
...
%		\includegraphics{./Figures/hists2B.pdf}
%		\includegraphics{./Figures/hists2B.pdf}
 		\includegraphics{./Figures/betaVaryDiversity.pdf}
  		\includegraphics{./Figures/thetaVaryDiversity.pdf}
  		\includegraphics{./Figures/NVaryDiversity.pdf}
  		\includegraphics{./Figures/deltaVaryDiversity.pdf}
